...
<head>
    ...
    <link rel="stylesheet" href={{asset('adminbs2/vendor/fontawesome-free/css/all.min.css') }}>
    <link
        href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i"
        rel="stylesheet">

    <!-- Custom styles for this template-->
    <link rel="stylesheet" href={{asset('adminbs2/css/sb-admin-2.min.css')}}>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
       @yield('sidebar', View::make('seller.sidebar'))
        <!-- End of Sidebar -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                @yield('header', View::make('layouts.common.header'))
                <!-- End of Topbar -->
            ...
            <!-- Footer -->
            @yield('footer', View::make('layouts.common.footer'))
            <!-- End of Footer -->
